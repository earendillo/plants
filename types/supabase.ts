  ...
  public: {
    Tables: {
      ...
      garden_share_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "garden_share_links_garden_id_fkey"
            columns: ["garden_id"]
            isOneToOne: false
            referencedRelation: "gardens"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_garden_owner: { Args: { p_garden_id: string }; Returns: boolean }
      is_valid_guest_token: {
        Args: { p_garden_id: string; p_token: string }
        Returns: boolean
      }
      validate_anonymous_share_link: {
        Args: { p_token: string }
        Returns: {
          expires_at: string
          garden_id: string
      ...
      water_plant: { Args: { p_plant_id: string }; Returns: undefined }
      water_plant_guest: {
        Args: { p_plant_id: string; p_token: string }
        Returns: number
      }
